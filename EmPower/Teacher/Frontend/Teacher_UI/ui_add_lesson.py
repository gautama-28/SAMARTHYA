...
"background-color: rgb(137, 218, 199);")
    ...
    def retranslateUi(self, Form):
        ...
        self.cmb_category.setItemText(1, _translate("Form", "Name Learning (Noun)"))
        self.cmb_category.setItemText(2, _translate("Form", "Verb Learning (Verb)"))
        self.cmb_category.setItemText(3, _translate("Form", "Association Learning (Association)"))
        self.cmb_category.setItemText(4, _translate("Form", "Activity Learning (Activity)"))
